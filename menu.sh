...
while true; do
  ...
  echo -e "  \e[35m[4]\e[0m ➤ Jalankan paketxldor"
  echo -e "  \e[35m[5]\e[0m ➤ Jalankan reedem"

  EXCLUDE_SET=" anomali-xl me-cli xldor paketxldor reedem "
  DYN_NAMES=()
  n=6
  ...
  case "$pilih" in
    ...
    4) run_or_clone "paketxldor" "https://github.com/PaketXL/paketxldor" ;;
